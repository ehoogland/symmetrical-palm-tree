 ...
 * @async The Redux thunk action creator function fetches the partners data asynchronously.
 ...
 * @promise {Promise} - A promise that resolves to the array of partners.
 * @returns {Promise} - A promise that resolves to the array of partners or throws an error message
...
export const fetchPartners = createAsyncThunk(
  ...
  async () => {
     ...
     * @constant response contains the value when the fetch call is resolved successfully
     * @rejects if the response is not ok and returns error message
    */
 ...
 * Redux toolkit's immer library handles immutability under the hood.
 ...
 * corresponding action creator automatically. Instead, they must be defined manually. Here,
 * we define reducers to handle the pending, fulfilled, and rejected states of the fetchPartners thunk.
 * @see https://redux-toolkit.js.org/api/createSlice
 * JavaScript computed property name [] notation is used to access the state in a more concise way. It lets us
 * use an expression in brackets [] to define an object property name, rather than a hard-coded string literal.
...
const partnersSlice = createSlice({
  ...
  extraReducers: {
    [fetchPartners.pending]: (state) => {
      state.isLoading = true; // Redux toolkit's immer converts "mutating" code to safe immutable updates. 
 ...
 * from the partners array of objects, returns that partner object,
 * along with the loading and error state, and exports it.
 */
