...
// The partnerRouter is an instance of the Express Router, which allows us to define
// routes for handling HTTP requests related to partners. It is used to create 
// modular route handlers for the /partners endpoint and its sub-routes.
